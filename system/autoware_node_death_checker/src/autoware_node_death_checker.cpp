...
#include "autoware_node_death_checker/autoware_node_death_checker.hpp"
...
: Node("autoware_node_death_checker", options)
{
  ignore_node_names_ =
...
RCLCPP_COMPONENTS_REGISTER_NODE(autoware::node_death_checker::NodeDeathMonitor)
