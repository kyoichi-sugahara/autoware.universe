...
TEST(TestLowpassFilter, MoveAverageFilter)
{
  namespace MoveAverageFilter =
    autoware::motion::control::lateral_optimal_controller::MoveAverageFilter;
  ...
  }  // namespace autoware::motion::control::lateral_optimal_controller::MoveAverageFilter;
  {
...
{
  using autoware::motion::control::lateral_optimal_controller::Butterworth2dFilter;
  const double dt = 1.0;
