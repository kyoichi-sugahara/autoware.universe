...
- **Node name**: `autoware_node_death_checker`
...
The `autoware_node_death_checker` node continuously reads the latest `launch.log` file, detects these messages, and logs a warning or marks the node as "dead."
...
Example **`autoware_node_death_checker.param.yaml`**:
