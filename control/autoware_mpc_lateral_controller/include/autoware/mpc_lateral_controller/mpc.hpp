...
private:
  ...
  rclcpp::Time m_previous_optimal_solution_time{
    0, 0, RCL_ROS_TIME};           // Time stamp of the last MPC solution.
...
public:
  ...
  double m_ctrl_period;                // Control loop period [s]. (inverse of frequency)
