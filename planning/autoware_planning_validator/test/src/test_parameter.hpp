...
constexpr double PARAMETER_TRAJECTORY_TO_OBJECT_DISTANCE = 30.0;
constexpr double PARAMETER_EGO_TO_OBJECT_DISTANCE = 50.0;
constexpr double PARAMETER_TIME_TOLERANCE = 0.5;
constexpr double PARAMETER_FORWARD_TRAJECTORY_LENGTH_VELOCITY = 10.0;
