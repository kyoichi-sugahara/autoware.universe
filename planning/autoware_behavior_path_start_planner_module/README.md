...
divide on planner type

| Name                                                        | Unit  | Type   | Description                                                                                                                                                                                                                                                                                                                           | Default value        |
| :---------------------------------------------------------- | :---- | :----- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | :------------------- |
| th_arrived_distance_m                                       | [m]   | double | distance threshold for arrival of path termination only [freespace planner]                                                                                                                                                                                                                                                           | 1.0                  |
...
| th_stopped_velocity_mps                                     | [m/s] | double | velocity threshold for arrival of path termination for [freespace planner]                                                                                                                                                                                                                                                            | 0.01                 |
| th_stopped_time_sec                                         | [s]   | double | time threshold for arrival of path termination only [freespace planner]                                                                                                                                                                                                                                                               | 1.0                  |
...
| length_ratio_for_turn_signal_deactivation_near_intersection | [m]   | double | deactivate turn signal of this module near intersection [unused_]                                                                                                                                                                                                                                                                     | 0.5                  |
...
| extra_width_margin_for_rear_obstacle                        | [m]   | double | extra width that is added to the perceived rear obstacle's width when deciding if the rear obstacle can overtake the ego vehicle while it is merging to$ colcon build --cmake-args -DCMAKE_BUILD_TYPE=Release --symlink-install --continue-on-error --cmake-clean-cache --packages-select autoware_behavior_path_start_planner_module |
| a lane from the shoulder lane.                              | 0.5   |
