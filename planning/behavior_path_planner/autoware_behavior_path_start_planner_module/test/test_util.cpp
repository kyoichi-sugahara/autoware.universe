...
//     autoware::behavior_path_planner::start_planner_utils::getBusStopAreaPolygons(shoulder_lanes);
...
//   EXPECT_EQ(
//     autoware::behavior_path_planner::start_planner_utils::isWithinAreas(
...
//       autoware::behavior_path_planner::start_planner_utils::combineLanePoints(points,
//       points_next);
...
//   // 3) check if the right bound of the departure check lane extended to the right end matches
//   the
...
//     autoware::behavior_path_planner::start_planner_utils::createDepartureCheckLanelet(
...
//     right_bound_points = autoware::behavior_path_planner::start_planner_utils::combineLanePoints(
